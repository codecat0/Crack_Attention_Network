...
class Fuse(nn.Module):
    ...
    def __init__(self, nn, scale, num_classes):
        super().__init__()
        self.nn = nn
        self.scale = scale
        self.conv = Conv3X3(64, num_classes)
...
class DeepCrack(nn.Module):
    ...
    def __init__(self, num_classes=2):
        ...
        self.fuse5 = Fuse(ConvRelu(512 + 512, 64), scale=16, num_classes=num_classes)
        self.fuse4 = Fuse(ConvRelu(512 + 256, 64), scale=8, num_classes=num_classes)
        self.fuse3 = Fuse(ConvRelu(256 + 128, 64), scale=4, num_classes=num_classes)
        self.fuse2 = Fuse(ConvRelu(128 + 64, 64), scale=2, num_classes=num_classes)
        self.fuse1 = Fuse(ConvRelu(64 + 64, 64), scale=1, num_classes=num_classes)

        self.final = Conv3X3(5 * num_classes, num_classes)
    ...
    def forward(self, inputs):
        ...
        return output, fuse1, fuse2, fuse3, fuse4, fuse5
